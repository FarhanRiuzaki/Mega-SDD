...
Provenance values:
  ...
  anchors_consulted:
    ...
    - src/app/(blank-layout-pages)/layout.tsx:12
...
DO NOT MODIFY:
  - src/app/(blank-layout-pages)/layout.tsx  (source: U-003.md `## Hard rules`)
DO NOT WRITE:
...
```
### T2 budget tracker
consumed_t1: 7001 bytes (cap 12288)
consumed_t2: 4575 bytes (cap 10240, hard 12288)
total: 11576 bytes  # T1 + T2 ONLY — the budgeted, truncatable content
file_total: 15977    bytes  # THIS WHOLE FILE; the gap from `total` is the four
...
truncations_applied:
  ...
  - validation_hints: drop section entirely (drop floor) (saved 145 bytes)
