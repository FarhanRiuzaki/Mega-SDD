...
index@32d5284e · 592 symbols · built by scripts/build-symbol-index.sh
...
```
### T2 budget tracker
consumed_t1: 6843 bytes (cap 12288)
consumed_t2: 610 bytes (cap 10240, hard 12288)
total: 7453 bytes  # T1 + T2 ONLY — the budgeted, truncatable content
file_total: 10158    bytes  # whole file incl. the un-budgeted blocks
truncations_applied:
  - (none)
```
