...
If the directory does not exist, tell the user the plugin isn't installed via marketplace and stop. Suggest `/plugin marketplace add https://github.com/FarhanRiuzaki/Mega-SDD.git` (or the appropriate add command for their setup).
