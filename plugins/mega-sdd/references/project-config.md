...
compaction_notice: true    # false → suppress the UserPromptSubmit "near context limit, /compact at a
                           #   phase boundary" advisory (PreCompact state snapshot still runs)
```
