...
**№3 build-dispatch-prompt — DITUTUP: DIBATALKAN KEDUANYA (keputusan user 2026-08-22, opsi i — JANGAN dibuka lagi).** Alasan tertulis: ekstraksi netto ~4% (±150 dari 3.713 baris) sambil menambah loader template + fail-mode + satu file parity-sensitive baru = gimmick per mandat no-gimmick; dan premis "4 kopi yaml_lite" ternyata 2 kopi verbatim + 2 varian toleransi regex + 1 parser beda desain — konsolidasi menyentuh perilaku, bukan dedupe mekanis. Golden parity harness tetap berdiri sebagai gate untuk ekstraksi opportunistik masa depan (ladder spec 2026-08-12 §P1 tidak dicabut — hanya item diet ini yang ditutup). Bukti di bawah:
