...
6. **Battle-tested domain knowledge.** The validators encode real lessons from the bank TF-Import pilot. The *knowledge* is valuable even where the *delivery mechanism* (40 bash scripts) is wrong.
