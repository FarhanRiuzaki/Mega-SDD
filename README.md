...
**Plugin:** `mega-sdd` · **Version:** 3.40.1 · **License:** MIT
...
| Iter 56 (v3.38.0) | post-Iter-55 fresh deep audit | 38 findings (8 P1 / 22 P2 / 8 P3) — same scale as Iter 38 | Iter 57-61 closed all P1s + 60% of P2s + key P3s; v3.38.1 → v3.40.x range |
...
- **Plugin**: SemVer. Major bump for breaking renames, rails changes, marketplace incompatibility, or new top-level entrypoints. v3.0 = ast-grep grammar migration. Currently 3.40.1.
...
├── plugins/mega-sdd/                       # the plugin itself (v3.40.1)
