...
**Plugin:** `mega-sdd` · **Version:** 3.57.0 · **License:** MIT
...
- **Plugin**: SemVer. Major bump for breaking renames, rails changes, marketplace incompatibility, or new top-level entrypoints. v3.0 = ast-grep grammar migration. Currently 3.57.0.
...
├── plugins/mega-sdd/                       # the plugin itself (v3.57.0)
