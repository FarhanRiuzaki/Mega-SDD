...
**Plugin location source:** `/Users/<user>/SunnyGo/2026/AIRND2026/Project/grand-design-spec/plugins/mega-sdd/`
...
python3 -c "import json,sys; p='/Users/<user>/SunnyGo/2026/AIRND2026/Project/tradefinance-import/.mega-sdd/vaults/tradefinance-phase-2-workflows-bound/vault.json'; d=json.load(open(p)); d['mode']='greenfield'; json.dump(d,open(p,'w'),indent=2)"
...
```bash
tail -1 /Users/<user>/SunnyGo/2026/AIRND2026/Project/tradefinance-import/.mega-sdd/memory/telemetry.jsonl
```
