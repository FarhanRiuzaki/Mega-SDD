...
**Field test:** user runs `/mega-sdd:auto` on `/Users/<user>/SunnyGo/2026/AIRND2026/Project/base-laravel-26`. First run writes routing-outcomes.md; second run consults it (cache hit on chain choice); predictive checks surface setup issues upfront.
