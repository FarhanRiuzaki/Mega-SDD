...
| P7 | 5.1.0 | bound/ retirement (refusal re-homed FIRST), bind-slice, advisor evidence-bundles, oq-queue, kb-claims, seeding-budget lib | legacy bound/ dirs inert-OK; bundles = seed never boundary |
