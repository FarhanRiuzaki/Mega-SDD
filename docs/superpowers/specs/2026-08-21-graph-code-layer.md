...
"env": { "ANTHROPIC_BASE_URL": "http://192.0.2.20:8001", "NO_PROXY": "192.0.2.20,…" }
```
...
- Ingest URL for the field test: `http://192.0.2.20:8001/mega-sdd/ingest`.
