...
bash plugins/mega-sdd/scripts/run-analyze.sh \
  --cwd=/Users/<user>/SunnyGo/2026/AIRND2026/Project/tradefinance-import
```
...
Run: `bash plugins/mega-sdd/scripts/run-analyze.sh --cwd=/Users/<user>/SunnyGo/2026/AIRND2026/Project/tradefinance-import`

Expected output: JSON with state_path + report_path + overall status.

- [ ] **Step 2: Read the CONSISTENCY-REPORT.md and verify contents**

Run: `cat /Users/<user>/SunnyGo/2026/AIRND2026/Project/tradefinance-import/.mega-sdd/CONSISTENCY-REPORT.md`
...
Run: `cat /Users/<user>/SunnyGo/2026/AIRND2026/Project/tradefinance-import/.mega-sdd/.analyze-state.json`
