...
bash "$P/scripts/stamp-binding-boilerplate.sh" --vault "$EV" >/dev/null 2>&1 \
  && pass "stamp-binding-boilerplate rc 0 on express binding" \
  || fail "stamp failed on express binding"
