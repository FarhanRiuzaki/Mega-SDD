...
Sample inputs (and outputs, when generated) demonstrating the `mega-sdd` plugin end-to-end.
...
| `timeoff/vault/` | Reference vault generated by `mega-sdd` from the PDF above. 7 markdown files, 48 Open Questions surfaced (12 P1 / 22 P2 / 14 P3). See the `00-index.md` Vault Lock Status for the flag values used. |
