...
- **Stakeholder OQ resolution round** → the resolve-oq walk ("resolve OQ"). Most useful AFTER PRD sign-off arrives and the team has stakeholder answers to capture.
- **PRD revises** → diff-vault ("PRD revisi"). Use when PRD goes from v1.0 → v1.1 (e.g., after Q1–Q5 from PRD §L are answered and a new PRD is published).
